class Solution:
    def findLadders(self, beginWord: str, endWord: str, wordList: List[str]) -> List[List[str]]:
        # BFS for shortest path then DFS for backtracking
        # 11/23/24) Sat) 942pm - 1130pm) 2hrs!) tk)
        d = defaultdict(list)
        ...
        # double ended BFS to cut down on search 
        ...
        def bfs(q, visited1, visited2, from_begin):
